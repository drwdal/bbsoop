...
class ReplyReport extends _IMGBOARD {
	/* CONSTANTS
	================================================== */
	const table = 'replies_reports';
	...
	public function destroy ( ) {
		return parent::destroy ( self::table );
	}
	...
	public function reply ( ) {
		return Reply::find ( ( int ) $this->reply_ID );
	}
	...
	private function apply_class_validations ( ) {
		...
		$this->reply_ID =	$this->validate_integer ( $this->reply_ID, TRUE, TRUE );
		$this->reason =		$this->validate_string ( $this->reason, TRUE );
		return true;
		// TODO: return human-readable errors?
	}
