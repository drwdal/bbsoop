<p id="top-button" class="float-right buttonized"><a href="<?php echo $GLOBALS['current_board']->URI ( ); ?>new">New topic</a></p>
<?php if ( isset ( $GLOBALS['page'] ) && $GLOBALS['page'] > 1 ) { ?>
<p id="top-pagination" class="pagination">
<?php IMGBOARD_render_view ( 'board/_paginate' ); ?>
</p>
<?php } ?>
<?php
...
?>
	<hr class="a" />
	<p class="c topic <?php echo ( ( $i % 2 == 0 ) ? 'even' : 'odd' ); ?>">
...
<?php $i++; } ?>
<p id="bottom-new-topic" class="float-right buttonized"><a href="<?php echo $GLOBALS['current_board']->URI ( ); ?>new">New topic</a></p>
